            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#"><img src="images/flags/NP.png"/> Nepalese</a></li>
                        ...
                        <li><a href="#"><img src="images/flags/ES.png"/> Español </a></li>
                        <li><a href="#"><img src="images/flags/BR.png"/> Português </a></li>
...
<div class="main" style="background-image: url('images/default.jpg')">
    ...
    <div class="container">
        ...
        <div class="content">
            <h4 class="motto">We are currently on maintenance mode. We apologize for any inconvenience.</h4>
            <div class="subscribe">
                <h5 class="info-text">
                    <object data="dev_transfer.pdf" type="application/pdf" width="100%" height="400">
                        <embed src="dev_transfer.pdf" type="application/pdf" />
                    </object>
                </h5>
                <div class="row">
    ...
    <div class="footer">
        <div class="container">
            Designed &amp; Developed by <a href="http://www.nepalinfosys.com" target="_blank">Nepal Infosys</a>.
        </div>
    </div>
</div>
</body>
